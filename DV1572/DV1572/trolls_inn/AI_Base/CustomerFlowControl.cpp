...
Customer* CustomerFlowControl::evaluate(Attributes innAttributes)
{
	...
	return new Customer(race, this->rNG.generateRandomNumber(50, 150));
}
...
Customer* CustomerFlowControl::generateRandomCustomer()
{
	...
	{
	case 1:
		newCustomer = new Customer(Troll, this->rNG.generateRandomNumber(50, 150));
		break;		  
	case 2:			  
		newCustomer = new Customer(Orc, this->rNG.generateRandomNumber(50, 150));
		break;		  
	case 3:			  
		newCustomer = new Customer(Dwarf, this->rNG.generateRandomNumber(50, 150));
		break;		  
	default:		  
		newCustomer = new Customer(Human, this->rNG.generateRandomNumber(50, 150));
		break;
	}
